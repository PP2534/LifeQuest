...
class LeaderboardPage extends Component
{
    ...
    public function render()
    {
        ...
        $users = $query->groupBy('users.id', 'users.name', 'users.avatar')
        ...
        if (auth()->check()) {
            ...
            // Kiểm tra xem người dùng hiện tại có trong trang hiện tại không
            $currentUserInPage = $users->firstWhere('id', $currentUserId);
