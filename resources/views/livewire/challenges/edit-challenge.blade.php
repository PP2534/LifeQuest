        ...
        <form wire:submit="update" class="bg-white shadow rounded-lg p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div wire:loading wire:target="selectedProvinceId" class="text-xs text-teal-600 mt-1">Đang tải...</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg border border-gray-200">
                <div class="flex items-start space-x-3">
                    <div class="flex items-center h-5">
                        <input id="need_proof" wire:model="need_proof" type="checkbox" class="focus:ring-teal-500 h-5 w-5 text-teal-600 border-gray-300 rounded">
                    </div>
                    <div class="ml-3 text-sm">
                        <label for="need_proof" class="font-medium text-gray-700">Yêu cầu ảnh minh chứng</label>
                    </div>
                </div>
                <div class="flex items-start space-x-3">
                    <div class="flex items-center h-5">
